...
$password2 = sanitizeMySQL($_POST['password2']);
...
if($password!=$password2)
  {
    echo "passwords do not match.<br /><a href=admin.php>Try Again</a>";
    exit;
  }
...
if($row['username']==$username)
	{
	echo "<b>$username</b> already in use<br />";
	exit;
	}
...
$query = "INSERT INTO users (username, password, viewnames,
deletepeople, deleteusers )
VALUES ( '$username', '$token','$viewnames', '$deletepeople',
'$deleteusers')";
...
echo "<b>$username</b> successfully created<br />";
mysql_close();
