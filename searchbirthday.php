...
// Build SQL Query  
$query = "select * from people where birthday like \"$birthday\" and
	  birthmonth like \"$birthmonth\" and birthyear like
	  \"$birthyear\" ";
...
echo "<p>You searched for records with the birthday: &quot;" . $birthmonth . "/" . $birthday . "/" . $birthyear .  "&quot;</p><br />";
...
//break before paging
  ...
  Précédent</a>&nbsp&nbsp;"; // Précédent = Previous
  }
...
$a = $s + ($limit) ;
  ...
  $b = $s + 1 ;
if ($a !== 0)
  echo "<p>Résultats $b à $a de $numrows</p>"; // Results = résultats
